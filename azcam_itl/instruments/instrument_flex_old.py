...
class InstrumentFlex(Instrument):
    """
    The Instrument interface to the ITL Flex test system.
    """
    ...
    def __init__(self, tool_id="instrument", description="Flex instrument"):
        ...
        self.power.service_name = "powerswitchflex"
        self.power.username = "lab"
        self.power.hostname = "powerswitchflex"

        # pressure controller instance
        # self.pressure = pressure_vgc401.PressureController("COM5")  # flex
        self.pressure = pressure_vgc501.PressureController("COM4")  # EB
